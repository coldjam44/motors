    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="text-center my-4"> <?php echo e(trans('main_trans.category')); ?></h3>
                <div class="text-right mb-3">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create apartments')): ?>
                    <a href="<?php echo e(route('categorys.create')); ?>" class="btn-bid-now" style="color:white; cursor:pointer">
            ...
            <button type="button" class=" button x-small  " data-toggle="modal" data-target="#exampleModal">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered data-table" id="data-table">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('categories.fields.show', $category->id)); ?>">
                                    ...
                                    <td>
                                        <img src="<?php echo e(asset('categorys/' . $category->image)); ?>" width="50" height="50">
                                    </td>

                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#edit<?php echo e($category->id); ?>"
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <input id="name_ar" type="text" name="name_ar"
                                                                    class="form-control"
                                                                    value="<?php echo e($category->name_ar); ?>"
                                                                    required>
                                                                <input id="id" type="hidden" name="id"
                                                                    class="form-control" value="<?php echo e($category->id); ?>">
                                                            </div>
                                                            <div class="col">
                                                                <label for="name_en"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="<?php echo e($category->name_en); ?>"
                        ...
                        <?php echo e($categorys->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azsystems-motors/htdocs/motors.azsystems.tech/public/resources/views/pages/categorys/categorys.blade.php ENDPATH**/ ?>