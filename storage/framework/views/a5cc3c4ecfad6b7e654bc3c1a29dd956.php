...
<html
  ...
  <head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="<?php echo e(asset('admin/assets/vendor/libs/@form-validation/umd/styles/index.min.css')); ?>" />
  ...
  <body>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-1 pt-2">Welcome to MOTORS! 👋</h4>
    ...
    <!-- Vendors JS -->
    <script src="<?php echo e(asset('admin/assets/vendor/libs/@form-validation/umd/bundle/popular.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/assets/vendor/libs/@form-validation/umd/plugin-bootstrap5/index.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/assets/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js')); ?>"></script>
...
<?php /**PATH /home/azsystems-motors/htdocs/motors.azsystems.tech/public/resources/views/auth/login.blade.php ENDPATH**/ ?>