    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="text-center my-4"> <?php echo e(trans('main_trans.city')); ?></h3>
                <div class="text-right mb-3">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create apartments')): ?>
                    <a href="<?php echo e(route('citys.create')); ?>" class="btn-bid-now" style="color:white; cursor:pointer">
                    ...
                    <table class="table table-bordered data-table" id="data-table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(trans('Counters_trans.country')); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $citys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <?php else: ?>
                                        <?php echo e($city->country->name_en); ?>

                                    <?php endif; ?></td>

                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#edit<?php echo e($city->id); ?>"
                                            title="<?php echo e(trans('Counters_trans.Edit')); ?>"><i
                                                class="fa fa-edit"></i></button>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete<?php echo e($city->id); ?>"
                                    ...
                                    <!-- edit_modal_Grade -->
                                    <div class="modal fade" id="edit<?php echo e($city->id); ?>" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- add_form -->
                                                    <form action="<?php echo e(route('citys.update',$city->id)); ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <input id="name_ar" type="text" name="name_ar"
                                                                    class="form-control"
                                                                    value="<?php echo e($city->name_ar); ?>"
                                                                    required>
                                                                <input id="id" type="hidden" name="id"
                                                                    class="form-control" value="<?php echo e($city->id); ?>">
                                                            </div>
                                                            <div class="col">
                                                                <label for="name_en"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="country_id"><?php echo e(trans('Counters_trans.country')); ?></label>
                                                            <select name="country_id" id="country_id" class="form-control form-select">
                                                                <option value=""><?php echo e(trans('Counters_trans.country')); ?></option>
                                                                <?php $__currentLoopData = $countrys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($category->id); ?>"
                                                                        <?php echo e(old('country_id', $city->country_id ?? '') == $category->id ? 'selected' : ''); ?>>
                                    ...
                                    <!-- delete_modal_Grade -->
                                    <div class="modal fade" id="delete<?php echo e($city->id); ?>" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('citys.destroy',$city->id)); ?>" method="post">
                        ...
                        <?php echo e($citys->links('pagination::bootstrap-5')); ?>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- add_form -->
                        <form action="<?php echo e(route('citys.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azsystems-motors/htdocs/motors.azsystems.tech/public/resources/views/pages/citys/citys.blade.php ENDPATH**/ ?>